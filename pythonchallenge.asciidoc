...
Well, I make a mistake, these two columns of hexadecimal are not themselves png files(though I they can be recognized by `file` as 620x200 png file), but need to be _diff_ use _difflib.ndiff_, 
